        ...
        <form action="{{ route('store') }}" method="post">
          @csrf
            ...
            <div class="form-group">
                ...
                <input type="date" id="duedate" name="duedate" class="form-control {{ $errors->has('duedate') ? 'is-invalid' : '' }}">
            ...
            <div class="form-group">
                ...
                <select id="priority" name="priority" class="form-control {{ $errors->has('priority') ? 'is-invalid' : '' }}">
